...
Securely install the latest [pdm-backend](https://pypi.org/project/pdm-backend/) release from PyPI.

This action installs a pinned version of **pdm-backend** and all its dependencies,         making sure that file hashes match. Pinning your dependencies:
...
```yaml
      - name: Install pdm-backend from PyPI
        uses: install-pinned/pdm-backend@1f104e8293c7ed1de426517fdb2556cee2bca112  # 2.1.7
```
